      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <Image src="/logo.png" alt="IEEE WIE Logo" width={50} height={50} className="mr-2" />
              <div>
                <h3 className="text-xl font-bold">Synexis</h3>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#speakers" className="text-gray-400 hover:text-pink-500 transition-colors">
                  Speakers
                </Link>
              </li>
              <li>
                <Link href="#sponsors" className="text-gray-400 hover:text-pink-500 transition-colors">
                  Sponsors
                </Link>
              </li>
              <li>
                <Link href="#register" className="text-gray-400 hover:text-pink-500 transition-colors">
                  Register
                </Link>
              </li>
              <li>
                <Link href="#volunteer" className="text-gray-400 hover:text-pink-500 transition-colors">
                  Volunteer
                </Link>
              </li>
            </ul>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:synexis@ieeewie.org" className="text-gray-400 hover:text-pink-500 transition-colors">
                  synexis@ieeewie.org
                </a>
              </li>
              <li className="flex items-center">
          ...
          <div className="md:col-span-1">
            ...
            <form className="space-y-3">
              <input
                ...
                className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500 text-white"
                required
              />
              <button
                type="submit"
                className="w-full bg-pink-600 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded-md transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400 text-sm">
          ...
          <p className="mt-2">
            ...
            {" | "}
            <Link href="/terms-of-service" className="hover:text-pink-500 transition-colors">
              Terms of Service
            </Link>
          </p>
        </div>
